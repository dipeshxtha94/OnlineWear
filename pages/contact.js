...
const Contact = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.h1detail}>Contact Details:</h1>
      <h3 className={styles.h3}>Email: onlinewear@gmail.com</h3>
      <h3 className={styles.h3}>Tel no: 4444-1266-1345</h3>
      <form className={styles.form} onSubmit={handleSubmit} action="">
      <h1 className={styles.h1}>Contact Us</h1><br/>
